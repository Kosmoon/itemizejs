...
[<img src="https://img.shields.io/badge/npm-1.0.6-blue.svg">](https://www.npmjs.com/package/itemizejs)
...
```html
<script src="https://cdn.jsdelivr.net/npm/itemizejs@1.0.6/itemize.min.js"></script>
```
